...
realize CR.addrA     by apply Coeff.ZModpRing.addrA    .
realize CR.addrC     by apply Coeff.ZModpRing.addrC    .
realize CR.add0r     by apply Coeff.ZModpRing.add0r    .
realize CR.addNr     by apply Coeff.ZModpRing.addNr    .
realize CR.oner_neq0 by apply Coeff.ZModpRing.oner_neq0.
realize CR.mulrA     by apply Coeff.ZModpRing.mulrA    .
realize CR.mulrC     by apply Coeff.ZModpRing.mulrC    .
realize CR.mul1r     by apply Coeff.ZModpRing.mul1r    .
realize CR.mulrDl    by apply Coeff.ZModpRing.mulrDl   .
realize CR.mulVr     by apply Coeff.ZModpRing.mulVr    .
realize CR.unitP     by apply Coeff.ZModpRing.unitP    .
realize CR.unitout   by apply Coeff.ZModpRing.unitout  .
